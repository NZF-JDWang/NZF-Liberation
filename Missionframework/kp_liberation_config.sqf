...
KP_liberation_ace_crates = [
    ...
    "nzf_NZBloodbox",
    "nzf_NZmedicalbox",
    "UK3CB_BAF_Box_Section_Supplies_Light",
...
KP_liberation_civinfo_duration = 2500;                                  // Civil Informant staytime until despawning. (seconds)
...
"76561198031386692","76561198113862876","76561197985286039", "76561199141814688", "76561198089268255" //JD, Fox, Agent, iRock, Kev
];
