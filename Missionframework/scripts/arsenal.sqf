...
_deltaSix = ["Delta_1","Delta_2","Delta_3","Delta_4"];

if (vehicleVarName player in _deltaSix) then {

	if ("Leader" in _playerRole) then {_role = "UNCcommand"};
	if ("Combat" in _playerRole) then {_role = "UNCCLS"; player setVariable ["Ace_medical_medicClass", 1];}; 
	if ("Operator" in _playerRole) then {_role = "UNCOperator"};
